...
static const vbr_presets_t vbr_old_switch_map[] = {
    /*vbr_q  qcomp_l  qcomp_s  expY  st_lrm   st_s  mask adj_l  adj_s  ath_lower  ath_curve
       ath_sens  interChR  safejoint sfb21mod  msfix */
...
static const vbr_presets_t vbr_mt_psy_switch_map[] = {
    /*vbr_q  qcomp_l  qcomp_s  expY  st_lrm   st_s  mask adj_l  adj_s  ath_lower  ath_curve
       ath_sens  ---  safejoint sfb21mod  msfix */
...
apply_abr_preset( lame_global_flags* gfp, int preset, int enforce )
{
    ...
    const abr_presets_t abr_switch_map[] = {
        /* kbps  quant q_s safejoint nsmsfix st_lrm  st_s  scale   msk ath_lwr ath_curve  interch ,
           sfscale */
        {8, 9, 9, 0, 0, 6.60, 145, 0.95, 0, -30.0, 11, 0.0012, 1},     /*   8, impossible to use in
                                                                          stereo */
    ...
    (void)lame_set_VBR_mean_bitrate_kbps( gfp,
                                          min_int( lame_get_VBR_mean_bitrate_kbps( gfp ), 320 ) );
    (void)lame_set_VBR_mean_bitrate_kbps( gfp,
                                          max_int( lame_get_VBR_mean_bitrate_kbps( gfp ), 8 ) );
