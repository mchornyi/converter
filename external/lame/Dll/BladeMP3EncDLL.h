    ...
    typedef struct
    {
        ...
        union {
            struct
            {
                ...
                WORD wBitrate;  // 32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256 and 320
                                // allowed
                BOOL bPrivate;
                BOOL bCRC;
                BOOL bCopyright;
            ...
            struct
            {
                ...
                LONG nPreset;  // Quality preset, use one of the settings of the LAME_QUALITY_PRESET
                               // enum
                ...
                WORD nQuality;    // Quality Setting, HIGH BYTE should be NOT LOW byte, otherwhise
                                  // quality=5
