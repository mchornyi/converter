    ...
    */
    ...
    int CDECL lame_encode_buffer_interleaved( lame_global_flags* gfp, /* global context handlei */
                                              ...
                                              int num_samples, /* number of samples per channel,
                                                                  ...
                                                                  pcm[]                         */
                                              unsigned char* mp3buf, /* pointer to encoded MP3
                                                                        stream */
    ...
    int CDECL lame_encode_buffer_interleaved_ieee_float( lame_t gfp,
                                                         const float pcm[], /* PCM data for left and
                                                                               right channel,
                                                                               interleaved */
                                                         const int nsamples,
                                                         unsigned char* mp3buf,
    ...
    int CDECL lame_encode_buffer_interleaved_ieee_double( lame_t gfp,
                                                          const double pcm[], /* PCM data for left
                                                                                 and right
                                                                                 channel,
                                                                                 interleaved */
                                                          const int nsamples,
    ...
    int lame_encode_buffer_interleaved_int( lame_t gfp,
                                            ...
                                            unsigned char* mp3buf, /* pointer to encoded MP3 stream
                                                                    */
                                            const int mp3buf_size ); /* number of valid octets in
                                                                        this stream */
    ...
    void CDECL lame_bitrate_stereo_mode_hist( const lame_global_flags* gfp,
                                              int bitrate_stmode_count[ 14 ][ 4 ] );

    void CDECL lame_block_type_hist( const lame_global_flags* gfp, int btype_count[ 6 ] );

    void CDECL lame_bitrate_block_type_hist( const lame_global_flags* gfp,
...
void CDECL lame_mp3_tags_fid( lame_global_flags*, FILE* fid );
     ...
     */
    size_t CDECL lame_get_lametag_frame( const lame_global_flags*,
...
int CDECL lame_decode_exit( void );
    ...
    /* experimental */
    int CDECL id3tag_set_comment_latin1( lame_t gfp,
                                         char const* lang,
                                         char const* desc,
                                         char const* text );
...
/* experimental */
int CDECL id3tag_set_comment_ucs2( lame_t gfp,
                                   char const* lang,
...
int CDECL id3tag_set_fieldvalue_ucs2( lame_t gfp, const unsigned short* fieldvalue );
    ...
    /* experimental */
    int CDECL id3tag_set_comment_utf16( lame_t gfp,
                                        char const* lang,
                                        unsigned short const* desc,
                                        unsigned short const* text );
