...
//
CUnknown* WINAPI
CMAEAbout::CreateInstance( LPUNKNOWN lpunk, HRESULT* phr )
{
...
CMAEAbout::CMAEAbout( LPUNKNOWN lpunk, HRESULT* phr )
    : CBasePropertyPage( NAME( "About LAME Ain't MP3 Encoder" ), lpunk, IDD_ABOUT, IDS_ABOUT )
...
HRESULT
CMAEAbout::OnConnect( IUnknown* pUnknown )
{
    return NOERROR;
}
...
BOOL
CMAEAbout::OnReceiveMessage( HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
