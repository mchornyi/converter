...
const char* chChMode[ 4 ] = {"Mono", "Standard stereo", "Joint stereo", "Dual channel"};

////////////////////////////////////////////////////////////////
// CreateInstance
////////////////////////////////////////////////////////////////
CUnknown*
CMpegAudEncPropertyPageAdv::CreateInstance( LPUNKNOWN punk, HRESULT* phr )
{
    CMpegAudEncPropertyPageAdv* pNewObject = new CMpegAudEncPropertyPageAdv( punk, phr );
...
CMpegAudEncPropertyPageAdv::CMpegAudEncPropertyPageAdv( LPUNKNOWN punk, HRESULT* phr )
    : CBasePropertyPage(
          NAME( "Encoder Advanced Property Page" ), punk, IDD_ADVPROPS, IDS_AUDIO_ADVANCED_TITLE )
    , m_pAEProps( NULL )
{
    ASSERT( phr );
...
HRESULT
CMpegAudEncPropertyPageAdv::OnConnect( IUnknown* pUnknown )
{
...
HRESULT
CMpegAudEncPropertyPageAdv::OnDisconnect( )
{
    // Release the interface
    if ( m_pAEProps == NULL )
        return E_UNEXPECTED;
...
HRESULT
CMpegAudEncPropertyPageAdv::OnActivate( void )
{
...
HRESULT
CMpegAudEncPropertyPageAdv::OnDeactivate( void )
{
    return NOERROR;
}
...
////////////////////////////////////////////////////////////////
BOOL
CMpegAudEncPropertyPageAdv::OnReceiveMessage( HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
    switch ( uMsg )
    {
    case WM_COMMAND:
        ...
        case IDC_CHECK_DISABLE_SHORT_BLOCK:
            m_pAEProps->set_NoShortBlock(
                IsDlgButtonChecked( hwnd, IDC_CHECK_DISABLE_SHORT_BLOCK ) );
            SetDirty( );
            break;
...
//
HRESULT
CMpegAudEncPropertyPageAdv::OnApplyChanges( )
{
    m_pAEProps->get_EnforceVBRmin( &m_dwEnforceVBRmin );
    m_pAEProps->get_VoiceMode( &m_dwVoiceMode );
    m_pAEProps->get_KeepAllFreq( &m_dwKeepAllFreq );
...
//
void
CMpegAudEncPropertyPageAdv::InitPropertiesDialog( HWND hwndParent )
{
    ...
    CheckRadioButton(
        hwndParent, IDC_RADIO_STEREO, IDC_RADIO_MONO, IDC_RADIO_STEREO + dwChannelMode );
    ...
    CheckDlgButton(
        hwndParent, IDC_CHECK_ENFORCE_MIN, dwEnforceVBRmin ? BST_CHECKED : BST_UNCHECKED );
    ...
    CheckDlgButton(
        hwndParent, IDC_CHECK_KEEP_ALL_FREQ, dwKeepAllFreq ? BST_CHECKED : BST_UNCHECKED );
    ...
    CheckDlgButton(
        hwndParent, IDC_CHECK_DISABLE_SHORT_BLOCK, dwNoShortBlock ? BST_CHECKED : BST_UNCHECKED );
...
////////////////////////////////////////////////////////////////
void
CMpegAudEncPropertyPageAdv::EnableControls( HWND hwndParent, bool bEnable )
{
