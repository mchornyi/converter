...
public:
    ...
    */
    inline const bool
    GetNoBiResMode( ) const
    {
        return bNoBitRes;
    }

    /**
        \brief Check wether the Encode process should force the channel mode (stereo or mono
       resampling)
    */
    inline const bool
    GetForceChannelMode( ) const
    {
        return bForceChannel;
    }
    ...
    */
    ...
    /**
        ...
        \note the Xing frame is a silent frame at the beginning that contain VBR statistics about
       the file.
    */
    inline const bool
    GetXingFrameMode( ) const
    {
        return bXingFrame;
    }
    ...
    */
    inline void
    SetCopyrightMode( const bool bMode )
    {
        bCopyright = bMode;
    }
    /**
    ...
    */
    inline void
    SetOriginalMode( const bool bMode )
    {
        bOriginal = bMode;
    }
    /**
    ...
    */
    inline void
    SetPrivateMode( const bool bMode )
    {
        bPrivate = bMode;
    }
    ...
    */
    inline void
    SetSmartOutputMode( const bool bMode )
    {
        bSmartOutput = bMode;
    }
    /**
    ...
    */
    inline void
    SetAbrOutputMode( const bool bMode )
    {
        bAbrOutput = bMode;
    }
    ...
    */
    inline void
    SetNoBiResMode( const bool bMode )
    {
        bNoBitRes = bMode;
    }

    /**
        \brief Set wether the Encode process should force the channel mode (stereo or mono
       resampling)
    */
    inline void
    SetForceChannelMode( const bool bMode )
    {
        bForceChannel = bMode;
    }
    ...
    */
    inline void
    SetVBRUseMode( const BRMode mode )
    {
        mBRmode = mode;
    }
    ...
    */
    inline void
    SetXingFrameMode( const bool bMode )
    {
        bXingFrame = bMode;
    }
    ...
    */
    inline const int
    GetBitrateString( char* string, int string_size ) const
    {
        return GetBitrateString( string, string_size, nMinBitrateIndex );
    }

    /**
        \brief Get the (VBR:min) bitrate corresponding to the specified index in the form of a
       string
    ...
    */
    inline const int
    GetBitrateLentgh( ) const
    {
        return sizeof( the_Bitrates ) / sizeof( unsigned int );
    }
    /**
        \brief Get the number of possible sampling frequencies
    */
    inline const unsigned int
    GetResampleFreq( ) const
    {
        return the_SamplingFreqs[ nSamplingFreqIndex ];
    }
    /**
    ...
    */
    ...
    GetSmartRatio( ) const
    {
        return SmartRatioMax;
    }
    /**
        \brief Get the min ABR bitrate possible
    */
    inline unsigned int
    GetAbrBitrateMin( ) const
    {
        return AverageBitrate_Min;
    }
    /**
        \brief Get the max ABR bitrate possible
    */
    inline unsigned int
    GetAbrBitrateMax( ) const
    {
        return AverageBitrate_Max;
    }
    /**
        \brief Get the step between ABR bitrates
    */
    inline unsigned int
    GetAbrBitrateStep( ) const
    {
        return AverageBitrate_Step;
    }
    ...
    /**
        ...
        \param VBRHeader receive the value that indicates wether the VBR/Xing header should be
       filled \param MPEG_Version The MPEG version (MPEG1 or MPEG2)

        \return the VBR mode (Old, New, ABR, MTRH, Default or None)
    */
    //	VBRMETHOD GetVBRValue(DWORD & MaxBitrate, int & Quality, DWORD & AbrBitrate, BOOL &
    ...
    */
    inline const char*
    GetChannelModeString( ) const
    {
        return GetChannelModeString( nChannelIndex );
    }
    /**
    ...
    */
    inline const int
    GetChannelLentgh( ) const
    {
        return 3;
    }

    /**
        \brief Get the current preset to use, see lame documentation/code for more info on the
       possible presets
    */
    ...
    */
    //	inline const int GetPresetLentgh() const { return sizeof(the_Presets) /
    //sizeof(LAME_QUALTIY_PRESET); }
...
private:
    ...
    inline void SetAttributeBool( TiXmlElement* the_elt,
