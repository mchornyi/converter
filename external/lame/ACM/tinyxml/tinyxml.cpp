...
void
TiXmlBase::PutString( const std::string& str, std::ostream* stream )
{
...
TiXmlNode*
TiXmlNode::IterateChildren( const std::string& val, TiXmlNode* previous ) const
{
    if ( !previous )
    {
...
void
TiXmlElement::RemoveAttribute( const std::string& name )
{
...
TiXmlElement*
TiXmlNode::FirstChildElement( const std::string& value ) const
{
    TiXmlNode* node;
...
TiXmlElement*
TiXmlNode::NextSiblingElement( const std::string& value ) const
{
    TiXmlNode* node;
...
void
TiXmlElement::SetAttribute( const std::string& name, const std::string& value )
{
    TiXmlAttribute* node = attributeSet.Find( name );
    if ( node )
    {
...
void
TiXmlElement::StreamOut( std::ostream* stream ) const
{
    ( *stream ) << "<" << value;
...
bool
TiXmlDocument::LoadFile( const std::string& filename )
{
...
bool
TiXmlDocument::SaveFile( const std::string& filename ) const
{
...
void
TiXmlDocument::StreamOut( std::ostream* out ) const
{
    TiXmlNode* node;
    for ( node = FirstChild( ); node; node = node->NextSibling( ) )
    {
...
void
TiXmlAttribute::StreamOut( std::ostream* stream ) const
{
...
void
TiXmlComment::StreamOut( std::ostream* stream ) const
{
    ( *stream ) << "<!--";
    PutString( value, stream );
    ( *stream ) << "-->";
...
void
TiXmlText::StreamOut( std::ostream* stream ) const
{
    PutString( value, stream );
}
...
void
TiXmlDeclaration::StreamOut( std::ostream* stream ) const
{
    ( *stream ) << "<?xml ";
...
void
TiXmlUnknown::StreamOut( std::ostream* stream ) const
{
