...
protected:
    ...
    */
    ...
    GetChar( const char* p, char* value )
    {
        assert( p );
        if ( *p == '&' )
        {
    ...
    bool static StringEqual( const char* p, const char* endTag, bool ignoreCase );
...
public:
    ...
    */
    ...
    TiXmlNode* FirstChild( const std::string& value ) const;  ///< The first child of this node with
                                                              ///< the matching 'value'. Will be
                                                              ///< null if none found.
    ...
    TiXmlNode* LastChild( const std::string& value ) const;  /// The last child of this node
                                                             /// matching 'value'. Will be null if
...
protected:
    ...
    void
    CopyToClone( TiXmlNode* target ) const
    {
        target->value = value;
    }
...
public:
    ...
    const double DoubleValue( ) const;  ///< Return the value of this attribute, converted to a
                                        ///< double.
