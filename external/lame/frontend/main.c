...
static wchar_t*
mbsToUnicode( const char* mbstr, int code_page )
{
...
static char*
unicodeToMbs( const wchar_t* wstr, int code_page )
{
...
char*
mbsToMbs( const char* str, int cp_from, int cp_to )
{
