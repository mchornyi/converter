...
extern "C"
{
    ...
    AudioWriter aw_open(lame_t gfp, char const* outPath, int pcmbystes, int freq, int channels, int
    bits); int     aw_writeWaveHeader(AudioWriter aw); int     aw_write(AudioWriter aw, short
    buffer[2][1152], int n); int     aw_write(AudioWriter aw, float buffer[2][1152], int n);
